...
import com.tms.dao.ClFreshLeadForAgen;
...
public class GetLeadForAgentServiceImpl extends BaseService implements GetLeadForAgentService {
    ...
    private final ClFreshLeadForAgen clFreshGetLeadForagen;

    public GetLeadForAgentServiceImpl(ClFreshLeadForAgen clFreshGetLeadForagen) {
